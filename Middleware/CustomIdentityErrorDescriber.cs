    ...
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError DuplicateEmail(string email)
        {
            return new IdentityError
            {
                ...
                Description = string.Format("O email {0} já está em uso.", email)
            };
        }
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = string.Format("Usuário com nome {0} já existe.", userName)
            };
        }
        ...
        public override IdentityError InvalidEmail(string email)
        {
            return new IdentityError
            {
                ...
                Description = string.Format("O email {0} não é válido.", email)
            };
        }
        ...
        public override IdentityError DuplicateRoleName(string role)
        {
            return new IdentityError
            {
                ...
                Description = string.Format("A função {0} já existe", role)
            };
        }
    }
}
